...
\begin{document}
	...
	To conlude many systems for computer aided diagnosis of malaria disease made use of mathematical operatations in order to smoothen the boundary of the regions obtained from the segmentation process, like in \cite{Dave2017}.
